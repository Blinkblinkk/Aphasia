...
public class MainHowToUse2 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.animation_list_2);
        ...
        slideShow.setBackgroundResource(R.drawable.slide_show2);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main_how_to_use2, menu);
        return true;
    }
